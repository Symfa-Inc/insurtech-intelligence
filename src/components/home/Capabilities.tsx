function DocumentIcon() {
  return (
    ...
    >
      ...
      <path d="M9 16.5h6m-6-3h6" strokeLinecap="round" />
    </svg>
  );
}
...
export function Capabilities() {
  return (
    <section id="capabilities" className="border-y border-border bg-surface/50 px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {capabilities.map((cap) => (
            <div
              key={cap.title}
              className="group rounded-xl border border-border bg-surface p-6 transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
            >
