...
export function Overview({ solution }: { solution: Solution }) {
  return (
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="leading-relaxed text-text-secondary">{solution.overview.problem}</p>
          </div>
          <div>
            <h3 className="mb-2 text-lg font-semibold text-primary">Our Solution</h3>
            <p className="leading-relaxed text-text-secondary">{solution.overview.solution}</p>
          </div>
          <div>
            <h3 className="mb-3 text-lg font-semibold text-primary">Key Outcomes</h3>
            <ul className="space-y-2">
              {solution.overview.outcomes.map((outcome, i) => (
